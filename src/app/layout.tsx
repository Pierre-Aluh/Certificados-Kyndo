...
export const metadata: Metadata = {
  title: {
    default: "Certikyndo | Certificado Digital em Goiânia e Todo Brasil",
    template: "%s | Certikyndo",
  },
  description:
  ...
  metadataBase: new URL("https://certikyndo.com.br"),
  keywords: [
  ...
  openGraph: {
    title: "Certikyndo | Certificado Digital em Goiânia e Todo Brasil",
    description:
  ...
  twitter: {
    ...
    title: "Certikyndo | Certificado Digital Soluti",
    description:
